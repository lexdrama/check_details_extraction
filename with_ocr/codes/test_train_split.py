...
def get_files_from_folder(path):
      ...
      _file = [f for f in files if f.endswith('.json')]
...
def parse_args():
    ...
    parser.add_argument("--data_path", required=False,\
                            default=r'C:\Users\Anshuman.Tiwari1\Downloads\all_data\all_data',\
                            help="Path to data")
      
    parser.add_argument("--test_data_path_to_save",required=False,\
                            default=r'C:\Users\Anshuman.Tiwari1\Downloads\all_data\split',\
